  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.cabecera}>
        ...
        <Text style={styles.nombre}>Usuario X</Text>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={[styles.mensaje, item.tipo === 'enviado' ? styles.enviado : styles.recibido]}>
            <Text style={{color: item.tipo === 'enviado' ? 'white' : 'black'}}>{item.texto}</Text>
