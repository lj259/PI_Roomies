...
class ChatController extends Controller
{
    ...
    public function index_props()
    {
        ...
        // Obtener todos los propietarios con los que el usuario ha interactuado a través de apartamentos
        $propietarios = Propietario::join('apartamentos', 'propietarios.id', '=', 'apartamentos.propietario_id')
            ->where('apartamentos.usuario_id', $usuario->id)
            ->select('propietarios.*')
            ->distinct()
            ->get();
