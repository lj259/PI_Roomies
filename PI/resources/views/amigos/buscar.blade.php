                                    ...
                                    <div class="col-md-6 col-lg-4 mb-3">
                                        <div class="card usuario-card h-100">
                                            <div class="card-body text-center">
                                                ...
                                                @endif
                                                <h6 class="card-title">{{ $usuario->nombre }} {{ $usuario->apellido_paterno }}</h6>
            ...
            @else
                ...
                <div class="card">
                    <div class="card-body text-center py-5">
                        ...
                        <p class="text-muted">Utiliza el formulario de arriba para buscar usuarios por nombre, apellido o correo electrónico.</p>
                    </div>
                </div>
            @endif
        </div>
