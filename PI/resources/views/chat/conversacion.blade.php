                                ...
                                <div class="amigo-item {{ $amigoItem->id == $amigo->id ? 'active' : '' }}"
                                    ...
                                    <div class="d-flex align-items-center">
                                        @if($amigoItem->foto_perfil && $amigoItem->foto_perfil !== 'perfil/default.jpg')
                                            <img src="{{ asset('storage/' . $amigoItem->foto_perfil) }}" alt="Foto de perfil"
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mb-0 small">{{ $amigoItem->nombre }} {{ $amigoItem->apellido_paterno }}
                                            </h6>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="chat-messages" id="chatMessages">
                            @foreach($mensajes as $mensaje)
                                <div
                                    class="mensaje {{ $mensaje->emisor_id == Auth::id() ? 'mensaje-propio' : 'mensaje-ajeno' }}">
                        ...
                        <div class="chat-input-container">
                            <form id="chatForm">
                                ...
                                <div class="input-group">
                                    <input type="text" id="mensajeInput" class="form-control chat-input"
