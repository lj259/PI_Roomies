        ...
        <div class="bg-light p-4 rounded col-md-8" style="background-color: #d9e4ff;">
            ...
            <form method="POST" action="/ValidarReportes">
                ...
                <div class="form-group">
                    <p>
                        <label class="d-block">
                            <input type="checkbox" name="chbox1" class="mr-2">
                            <strong>1. Contenido inapropiado:</strong>
                            Publicación de contenido ofensivo, inapropiado, difamatorio o amenazante.
                        </label>
                        <label class="d-block">
                            <input type="checkbox" name="chbox2" class="mr-2">
                            <strong>2. Acoso:</strong>
                            Enviar mensajes de odio, acoso o intimidación a otros usuarios.
                        </label>
                        <label class="d-block">
                            <input type="checkbox" name="chbox3" class="mr-2">
                            <strong>3. Fraude o engaño:</strong>
                            Difusión de rumores, enlaces con malware o intentos de estafa.
                        </label>
                        <label class="d-block">
                            <input type="checkbox" name="chbox4" class="mr-2">
                            <strong>4. Suplantación de identidad:</strong>
                            Hacerse pasar por otra persona sin su consentimiento.
                        </label>
                        <label class="d-block">
                            <input type="checkbox" name="chbox5" class="mr-2">
                            <strong>5. Spam:</strong>
                            Enviar mensajes no solicitados de manera masiva.
                        </label>
                    </p>
                </div>
